...
function(C, e) {
    ...
    var h = function(n) {
        ...
        function be(s, e, t) {
            ...
            function(e, t, n) {
                ...
                } else for (; e = e[u];) if (1 === e.nodeType || f) if (i = (o = e[k] || (e[k] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()) e = e[u] || e;
                else {
        ...
        f = se.compile = function(e, t) {
            ...
            a = N[e + " "];
            if (!a) {
                for (t || (t = h(e)), n = t.length; n--;)(a = Ee(t[n]))[k] ? i.push(a) : o.push(a); (a = N(e, (v = o, m = 0 < (y = i).length, x = 0 < v.length, r = function(e, t, n, r, i) {
                    var o, a, s, u = 0,
                    l = "0",
                    c = e && [],
                    f = [],
    ...
    k.Callbacks = function(r) {
        ...
        f = {
            ...
            remove: function() {
                ...
                function(e, t) {
                    for (var n; - 1 < (n = k.inArray(t, s, n));) s.splice(n, 1),
                    n <= l && l--
                }),
                this
            },
    ...
    var _ = function(e, t, n, r, i, o, a) {
        ...
        else if (void 0 !== r && (i = !0, m(r) || (a = !0), l && (t = a ? (t.call(e, r), null) : (l = t,
        function(e, t, n) {
            return l.call(k(e), n)
    ...
    k.fn.extend({
        ...
        promise: function(e, t) {
            function s() {--r || i.resolveWith(o, [o])
            }
            var n, r = 1,
            i = k.Deferred(),
            o = this,
    ...
    function le(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--;) k.style(e, t, c + l),
            (1 - o) * (1 - (o = s() / u || .5)) <= 0 && (a = 0),
            c /= o;
            c *= 2,
            k.style(e, t, c + l),
    ...
    function we(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; o = p[d++];) if (r && -1 < k.inArray(o, r)) i && i.push(o);
    ...
    k.Animation = k.extend(dt, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0,
            i = (e = m(e) ? (t = e, ["*"]) : e.match(R)).length; r < i; r++) n = e[r],
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    ...
                    o = k.makeArray(t), a = i.length; a--;)((r = i[a]).selected = -1 < k.inArray(k.valHooks.option.get(r), o)) && (n = !0);
...
function() {
    ...
    h.max = function(n, e, r) {
        var t, u, i = -1 / 0,
        o = -1 / 0;
        if (null == e || "number" == typeof e && "object" != typeof n[0] && null != n) for (var a = 0,
        c = (n = w(n) ? n: h.values(n)).length; a < c; a++) null != (t = n[a]) && i < t && (i = t);
        else e = d(e, r),
        h.each(n,
        function(n, r, t) {
            u = e(n, r, t),
    ...
    h.min = function(n, e, r) {
        ...
        o = 1 / 0;
        if (null == e || "number" == typeof e && "object" != typeof n[0] && null != n) for (var a = 0,
        c = (n = w(n) ? n: h.values(n)).length; a < c; a++) null != (t = n[a]) && t < i && (i = t);
        else e = d(e, r),
        h.each(n,
    ...
    h.sample = function(n, r, t) {
        if (null == r || t) return w(n) || (n = h.values(n)),
    ...
    var M = function(n, r, t, e) {
        for (var u = (e = e || []).length, i = 0, o = A(n); i < o; i++) {
            var a = n[i];
            if (w(a) && (h.isArray(a) || h.isArguments(a))) if (r) for (var c = 0,
            l = a.length; c < l;) e[u++] = a[c++];
            else M(a, r, t, e),
            u = e.length;
            else t || (e[u++] = a)
        }
    ...
    h.object = function(n, r) {
        for (var t = {},
        e = 0,
        u = A(n); e < u; e++) r ? t[n[e]] = r[e] : t[n[e][0]] = n[e][1];
        return t
    };
    function F(i) {
        return function(n, r, t) {
    ...
    h.partial = g(function(u, i) {
        ...
        a = function() {
            for (var n = 0,
            r = i.length,
            t = Array(r), e = 0; e < r; e++) t[e] = i[e] === o ? arguments[n++] : i[e];
    ...
    h.throttle = function(t, e, u) {
        ...
        var n = function() {
            ...
            return o = this,
            a = arguments,
            r <= 0 || e < r ? (i && (clearTimeout(i), i = null), l = n, c = t.apply(o, a), i || (o = a = null)) : i || !1 === u.trailing || (i = setTimeout(f, r)),
            c
        };
    ...
    h.mapObject = function(n, r, t) {
        r = d(r, t);
        for (var e = h.keys(n), u = e.length, i = {},
        o = 0; o < u; o++) {
            var a = e[o];
            i[a] = r(n[a], a, n)
        }
    ...
    h.invert = function(n) {
        for (var r = {},
        t = h.keys(n), e = 0, u = t.length; e < u; e++) r[n[t[e]]] = t[e];
        return r
    },
    ...
    h.each(["Arguments", "Function", "String", "Number", "Date", "RegExp", "Error", "Symbol", "Map", "WeakMap", "Set", "WeakSet"],
    function(r) {
        h["is" + r] = function(n) {
    ...
    V = /\\|'|\r|\n|\u2028|\u2029/g;
    h.template = function(i, n, r) { ! n && r && (n = r),
        n = h.defaults({},
...
function(t) {
    ...
    a.trigger = function(t) {
        ...
        return u(v, this._events, t, void 0, i),
        this
    };
    ...
    g.prototype.on = a.on,
    g.prototype.off = function(t, e) { (this.interop ? (this._events = u(f, this._events, t, e, {
            context: void 0,
            listeners: void 0
    ...
    i.extend(m.prototype, a, {
        ...
        save: function(t, e, n) {
            ...
            n.success = function(t) {
                ...
                if (s && (e = i.extend({},
                r, e)), e && !a.set(e, n)) return ! 1;
                o && o.call(n.context, a, t, n),
                a.trigger("sync", a, t, n)
            },
            G(this, n),
            r && s && (this.attributes = i.extend({},
            h, r));
        ...
        destroy: function(t) {
            ...
            return this.isNew() ? i.defer(t.success) : (G(this, t), a = this.sync("delete", this, t)),
            r || s(),
            a
        },
        url: function() {
    ...
    i.extend(_.prototype, a, {
        ...
        set: function(t, e) {
            if (null != t) { (e = i.extend({},
                y, e)).parse && !this._isModel(t) && (t = this.parse(t, e) || []);
                var n = !i.isArray(t);
                t = n ? [t] : t.slice();
                var r = e.at;
                null != r && (r = +r),
                ...
                var w = !1,
                E = !v && l && f;
                if (s.length && E ? (w = this.length !== s.length || i.some(this.models,
                function(t, e) {
                    return t !== s[e]
                    ...
                    for (m = 0; m < a.length; m++) null != r && (e.index = r + m),
                    (g = a[m]).trigger("add", g, this, e); (d || w) && this.trigger("sort", this, e),
                    (a.length || h.length || o.length) && (e.changes = {
                        added: a,
                        removed: h,
                        merged: o
                    },
    ...
    var C = function(t, e) {
        return i.isFunction(t) ? t: i.isObject(t) && !e._isModel(t) ? R(t) : i.isString(t) ?
        function(e) {
            return e.get(t)
        }: t
    },
    ...
    i.extend(O.prototype, a, {
        ...
        route: function(t, n, r) {
            ...
            function(i) {
                var a = s._extractParameters(t, i); ! 1 !== s.execute(r, a, n) && (s.trigger.apply(s, ["route:" + n].concat(a)), s.trigger("route", n, a), e.history.trigger("route", s, n, a))
            }),
            this
        },
        ...
        _routeToRegExp: function(t) {
            return t = t.replace(F, "\\$&").replace(U, "(?:$1)?").replace(z,
            function(t, e) {
                return e ? t: "([^/?]+)"
            }).replace(q, "([^?]*?)"),
            new RegExp("^" + t + "(?:\\?([\\s\\S]*))?$")
    ...
    i.extend(B.prototype, a, {
        ...
        navigate: function(t, e) {
            ...
            if (this.fragment !== r) {
                if (this.fragment = r, this._usePushState) this.history[e.replace ? "replaceState": "pushState"]({},
                document.title, n);
                else {
...
function() {
    ...
    e.FieldRef.prototype.toString = function() {
        return null == this._stringValue && (this._stringValue = this.fieldName + e.FieldRef.joiner + this.docRef),
        this._stringValue
    },
    e.Set = function(e) {
    ...
    e.Pipeline.prototype.run = function(e) {
        for (var t = this._stack.length,
        r = 0; r < t; r++) {
            for (var i = this._stack[r], n = [], s = 0; s < e.length; s++) {
                var o = i(e[s], s, e);
                if (void 0 !== o && "" !== o) if (Array.isArray(o)) for (var a = 0; a < o.length; a++) n.push(o[a]);
                else n.push(o)
            }
            e = n
        }
    ...
    e.Vector.prototype.positionForIndex = function(e) {
        ...
        i = r - t,
        n = Math.floor(i / 2), s = this.elements[2 * n]; 1 < i && (s < e && (t = n), e < s && (r = n), s != e);) i = r - t,
        n = t + Math.floor(i / 2),
        s = this.elements[2 * n];
    ...
    e.Vector.prototype.dot = function(e) {
        ...
        a = 0,
        u = 0,
        l = 0; u < n && l < s;)(o = r[u]) < (a = i[l]) ? u += 2 : a < o ? l += 2 : o == a && (t += r[u + 1] * i[l + 1], u += 2, l += 2);
        return t
    },
    ...
    e.stemmer = function() {
        ...
        I = function(r) {
            ...
            if ("y" == (s = r.substr(0, 1)) && (r = s.toUpperCase() + r.substr(1)), a = y, (o = p).test(r) ? r = r.replace(o, "$1$2") : a.test(r) && (r = r.replace(a, "$1$2")), a = v, (o = m).test(r)) {
                var I = o.exec(r); (o = c).test(I[1]) && (o = g, r = r.replace(o, ""))
            } else if (a.test(r)) {
                i = (I = a.exec(r))[1],
                (a = f).test(i) && (u = w, l = Q, (a = x).test(r = i) ? r += "e": u.test(r) ? (o = g, r = r.replace(o, "")) : l.test(r) && (r += "e"))
            } (o = k).test(r) && (r = (i = (I = o.exec(r))[1]) + "i"); (o = S).test(r) && (i = (I = o.exec(r))[1], n = I[2], (o = c).test(i) && (r = i + e[n])); (o = E).test(r) && (i = (I = o.exec(r))[1], n = I[2], (o = c).test(i) && (r = i + t[n]));
    ...
    e.TokenSet.fromArray = function(t) {
        for (var r = new e.TokenSet.Builder,
        i = 0,
        n = t.length; i < n; i++) r.insert(t[i]);
        return r.finish(),
        r.root
    },
    ...
    e.TokenSet.prototype.intersect = function(t) {
        ...
        n = [{
            ...
            i = n.pop();
            for (var s = Object.keys(i.qNode.edges), o = s.length, a = Object.keys(i.node.edges), u = a.length, l = 0; l < o; l++) for (var c = s[l], h = 0; h < u; h++) {
                var d = a[h];
                if (d == c || "*" == c) {
                    ...
                    y = f.final && p.final,
                    m = void 0;
                    d in i.output.edges ? (m = i.output.edges[d]).final = m.final || y: ((m = new e.TokenSet).final = y, i.output.edges[d] = m),
                    n.push({
                        qNode: p,
                        output: m,
                        node: f
    ...
    e.Index.prototype.query = function(t) {
        ...
        for (u = 0; u < r.clauses.length; u++) {
            ...
            if (l.presence === e.Query.presence.REQUIRED) for (m = 0; m < l.fields.length; m++) {
    ...
    e.Builder.prototype.createFieldVectors = function() {
        for (var t = {},
        r = Object.keys(this.fieldTermFrequencies), i = r.length, n = Object.create(null), s = 0; s < i; s++) {
    ...
    e.MatchData.prototype.add = function(e, t, r) {
        if (! (e in this.metadata)) return this.metadata[e] = Object.create(null),
        void(this.metadata[e][t] = r);
        if (t in this.metadata[e]) for (var i = Object.keys(r), n = 0; n < i.length; n++) {
            var s = i[n];
    ...
    e.QueryLexer.lexText = function(t) {
        for (;;) {
            ...
            if (92 != r.charCodeAt(0)) {
                ...
                if ("~" == r) return t.backup(),
                0 < t.width() && t.emit(e.QueryLexer.TERM),
                e.QueryLexer.lexEditDistance;
                if ("^" == r) return t.backup(),
                0 < t.width() && t.emit(e.QueryLexer.TERM),
                e.QueryLexer.lexBoost;
                if ("+" == r && 1 === t.width()) return t.emit(e.QueryLexer.PRESENCE),
                e.QueryLexer.lexText;
                if ("-" == r && 1 === t.width()) return t.emit(e.QueryLexer.PRESENCE),
                e.QueryLexer.lexText;
...
function(typedoc) {
    ...
    "undefined" != typeof Backbone && (typedoc.Events = function() {},
        ...
        Application.prototype.createComponents = function($context, namespace) {
            ...
            return _(components).forEach(function(c) {
                c.namespace != namespace && "*" != c.namespace || $context.find(c.selector).each(function(m, el) {
                    var instance, $el = $(el); (instance = $el.data("component")) ? -1 == _(result).indexOf(instance) && result.push(instance) : (instance = new c.constructor({
                        el: el
...
function(typedoc) {
    ...
    typedoc.isMobile && "ontouchstart" in document.documentElement && (typedoc.isPointerTouch = !0, typedoc.pointerDown = "touchstart", typedoc.pointerMove = "touchmove", typedoc.pointerUp = "touchend"),
    typedoc.$document.on(typedoc.pointerDown,
    function(e) {
...
function(typedoc) {
    ...
    Filter = function(_super) {
        function Filter(options) {
            ...
            return _this.optionVisibility = new FilterItemSelect("visibility", "private"),
...
function(typedoc) {
    var MenuHighlight = function(_super) {
        ...
        MenuHighlight.prototype.createAnchors = function() {
            ...
            var base = window.location.href; - 1 != base.indexOf("#") && (base = base.substr(0, base.indexOf("#"))),
        ...
        MenuHighlight.prototype.onResize = function() {
            for (var anchor, index = 1,
            count = this.anchors.length; index < count; index++)(anchor = this.anchors[index]).position = anchor.$anchor.offset().top;
        ...
        MenuSticky.prototype.onResize = function(width, height) {
            ...
            if (this.$navigation.height() < containerHeight) {
                ...
                if (this.$current.length) {
                    ...
                    currentHeight < height && (this.stickyMode = StickyMode.Current, this.stickyTop = currentTop, this.stickyBottom = bottom - elHeight + (currentTop - elTop) - 20)
                }
...
function(typedoc) {
    ...
    function(search) {
        ...
        function createIndex() {
            ...
            length = rows.length; !
            function batch() {
                for (var cycles = 0; cycles++<100;) if (builder.add(rows[pos]), ++pos == length) return index = builder.build(),
        ...
        function updateResults() {
            if ($results.empty(), loadingState == SearchLoadingState.Ready && query) {
                ...
                c = Math.min(10, res.length); i < c; i++) {
                    ...
                    name = row.name.replace(new RegExp(query, "i"),
                    function(match) {
                        return "<b>" + match + "</b>"
                    }),
                    parent = row.parent || ""; (parent = parent.replace(new RegExp(query, "i"),
                    function(match) {
                        return "<b>" + match + "</b>"
...
function(typedoc) {
    ...
    typedoc.transition = function(tuples) {
        for (var name in tuples) if (tuples.hasOwnProperty(name) && void 0 !== document.body.style[name]) return {
            name: name,
    ...
    typedoc.animateHeight = function($el, callback, success) {
        ...
        from != to && typedoc.transition ? ($el.css("height", to), $el.on(typedoc.transition.endEvent,
        function() {
            noTransition($el,
            function() {
...
function(typedoc) {
    ...
    Signature = function(_super) {
        function Signature(options) {
            ...
            _this.index = -1,
            _this.createGroups(),
            _this.$container && (_this.$el.addClass("active").on("touchstart", ".tsd-signature",
            function(event) {
                return _this.onClick(event)
            }).on("click", ".tsd-signature",
            function(event) {
                return _this.onClick(event)
...
function(typedoc) {
    var Toggle = function(_super) {
        function Toggle(options) {
            ...
            typedoc.$document.on(typedoc.pointerUp,
            function(e) {
        ...
        Toggle.prototype.onDocumentPointerUp = function(e) {
            ...
            if (!typedoc.hasPointerMoved && this.active) {
                ...
                if ($path.hasClass("col-menu")) {
                    ...
                    if ($link.length) {
                        var href = window.location.href; - 1 != href.indexOf("#") && (href = href.substr(0, href.indexOf("#"))),
                        $link.prop("href").substr(0, href.length) == href && setTimeout(function() {
